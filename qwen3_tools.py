...
def upload_csv_file(file_path: str, upload_url: str = "https://igs.gov-cloud.ai/pi-file-service/v1.0/upload") -> str:
    """
    Uploads a CSV file to a specified URL using a POST request and returns the CDN URL.
...
TOOL_DESCRIPTIONS = {
    "upload_csv_file": {
        ...
        "example": {
            "input": {
                ...
                "upload_url": "https://igs.gov-cloud.ai/pi-file-service/v1.0/upload"
            },
            "output": "https://cdn.gov-cloud.ai/path/to/uploaded/file.csv"
        }
    },
    "create_ingestion_job": {
        ...
        "example": {
            "input": {
                "file_url": "https://cdn.gov-cloud.ai/path/to/file.csv",
